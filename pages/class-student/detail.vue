				...
				<view class="u-pos-box u-scroll-y">
					...
					<view v-show="current === 1">
						...
						<view class="u-fx-ac u-padd u-bd-b u-content-color" v-for="user in changeList" :key="user.id">
							...
							<view class="u-fx-f1 u-fx-jc">
								{{$tools.getDateTime(user.createTime, 'date')}}
							</view>
						</view>
					</view>
					<view v-show="current === 2">
						...
						<view class="u-fx-ac u-padd u-bd-b u-content-color" v-for="user in dormList" :key="user.id">
							<view class="u-fx-jc">
								{{user.status | dormType}}
							</view>
							<view class="u-fx-f1 u-tx-c">
								{{user.oldBuildingName}}
							</view>
							<view class="u-fx-f1 u-tx-c">
								{{user.newBuildingName}}
							</view>
							<view class="u-fx-f1 u-fx-jc">
								{{$tools.getDateTime(user.updateTime, 'date')}}
							</view>
						</view>
					</view>
				</view>
