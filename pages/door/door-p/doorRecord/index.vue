  ...
  <view class="u-page">
    ...
    <view class="head">
      <button type="default" @click="onShowDatePicker('rangetime')">
        <text v-if="this.rangetime.length !== 0"
          >{{ rangetime[0] | gmtToDate("date") }}~{{
            rangetime[1] | gmtToDate("date")
          }}</text
        >
    ...
    <view class="list">
      ...
      <scroll-view scroll-y="true" class="scroll-h" @scrolltolower="loadMore">
        ...
        >
          ...
          ><view class="rit-icon" @click="goDetail(item)"></view>
        </view>
      </scroll-view>
    </view>
  </view>
    ...
    goDetail(item) {
      this.$tools.navTo({
        url:
          ...
          item.accessType +
          "&accessTime=" +
          this.getDateTime(new Date(item.accessTime)),
        title: "查看出入详情",
      });
    },
