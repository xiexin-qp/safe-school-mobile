	...
	<view>
		<scroll-view scroll-y="true" class="scroll-h">
			...
			<view class="u-bd-b item-list" v-if="type === '0' || formData.attachList.length > 0">
				...
				<view class="u-fx-f1">
					<view class="u-fx-f1"><an-upload-img showName :disabled="type !== '0'" total="9" v-model="formData.attachList" class="upload"></an-upload-img></view>
				</view>
			</view>
	...
	methods: {
		...
		async showData() {
			...
			this.formData = {
				...
				gradeClassName: res.data.homework.gradeName + res.data.homework.className,
