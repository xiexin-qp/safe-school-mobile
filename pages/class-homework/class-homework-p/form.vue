	...
	<view class="u-auto">
		<scroll-view v-if="list[current] && type === '1'" scroll-y="true" class="scroll-h">
			...
			<view class="u-fx-ac u-bd-b item-list">
				<view>班级：</view>
				<view class="u-fx-f1 u-fx-je u-tips-color u-mar-r20">{{ list[current].grade_name }}{{ list[current].class_name }}</view>
			</view>
			<view class="u-fx-ac u-bd-b item-list">
				<view>学科：</view>
		...
		<scroll-view v-if="type === '2'" scroll-y="true" class="scroll-h">
			...
			<view class="u-fx-ac u-bd-b item-list">
				<view>班级：</view>
				<view class="u-fx-f1 u-fx-je u-tips-color u-mar-r20">{{ homeworkInfo.homework.gradeName }}{{ homeworkInfo.homework.className }}</view>
			</view>
			<view class="u-fx-ac u-bd-b item-list">
				<view>学科：</view>
