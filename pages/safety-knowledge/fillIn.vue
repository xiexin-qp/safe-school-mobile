	...
	<view>
		<scroll-view scroll-y="true" class="scroll-h" v-if="Object.keys(detailInfo).length>0">
			...
			<view class="cont u-type-white-bg u-padd-l10 u-padd-r10 u-tips-color">
				...
				<u-row v-if="detailInfo.des" class='u-mar-b10 u-padd-t30 ' justify="start">
				...
				<view class="problem-list" v-if="fillList.length !== 0">
					<view>
						...
						<view class="wentiList u-mar-l20 u-mar-r20  u-type-white-bg " v-for="(list, i) in fillList" :key="i">
							...
							<u-row>
								<u-col span="24" class=" u-main-color u-type-white-bg u-padd-t10">
									<u-input class="u-mar-l20" v-model="list.answers[0]" v-if='!type||type===2' :disabled="!type" type="textarea"
									 :auto-height="true" />
									<u-input class="u-mar-l20" v-model="list.answer" v-else :disabled="!type" type="textarea" placeholder='请在此填写'
									 :auto-height="true" />
								</u-col>
							</u-row>
						</view>
