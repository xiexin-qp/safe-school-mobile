<template>
	<view class="dropDown u-fx">
		<ms-dropdown-menu class='u-mar-r20 u-border-radius'>
			<ms-dropdown-item v-model="value0Change" :list="List0"></ms-dropdown-item>
		</ms-dropdown-menu>
		<ms-dropdown-menu class='u-mar-r20 u-border-radius'>
			<ms-dropdown-item v-model="value1Change" :list="typeListTime"></ms-dropdown-item>
		</ms-dropdown-menu>
			<ms-dropdown-menu>
			<ms-dropdown-item v-model="value2Change" :list="typeListTime"></ms-dropdown-item>
		</ms-dropdown-menu>
	</view>
</template>
	...
	export default {
		...
		watch: {
			value0Change(val, oldval) {
				...
				if (val !== oldval) {
					this.$emit('value0Change', this.value0Change);
				}
			},
			...
			value2Change(val, oldval) {
				...
				if (val !== oldval) {
					this.$emit('value2Change', this.value2Change);
				}
			},
