<template>
	<view class="dropDown u-fx" v-if="gradeList.length > 0">
		<ms-dropdown-menu><ms-dropdown-item v-model="value0" :list="gradeList"></ms-dropdown-item></ms-dropdown-menu>
		<ms-dropdown-menu><ms-dropdown-item v-model="value1" :list="classList" :title="defTitle"></ms-dropdown-item></ms-dropdown-menu>
	</view>
</template>
