<template>
	<view class="detail-show u-padd-20 ">
		...
		<view v-if="type === 't'" class="detail-file u-type-white-bg u-border-radius u-auto">
			<view class="file-title u-mar-t20 u-mar-l20 u-padd-l10 u-bold">发布班级</view>
			<view class="u-fx-ac u-padd-20">
				<view v-if="studyInfo.schoolGradeCode === '00'" class=""><u-tag class="u-mar-b20 u-mar-r20" size="mini" type="primary" text="全部" /></view>
				<view v-else>
					<u-tag
						class="u-mar-b20 u-mar-r20"
						size="mini"
						type="primary"
						:text="item.gradeName + item.className"
						v-for="(item, i) in studyInfo.classList"
						:key="item.classCode"
						:index="i"
					/>
				</view>
