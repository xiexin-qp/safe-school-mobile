<template>
  <view class="container">
    <no-data v-if="detail === ''" msg="暂无数据"></no-data>
    <view v-else class="set_box">
      <view class="set_time">
      ...
      <view class="set-1">
        <view class="set-2">
          <view class="right u-fx-ver">
            <text class="detail">申请人： {{ detail.submitUserName }} </text>
          </view>
        </view>
      </view>
    </view>
          ...
          <view class="right u-fx-ver">
            <view class="u-fx">
              ...
              <view>
                <view
                  class="u-fx"
                  v-for="(item, index) in detail.repairApprovalList"
                  :key="index"
                >
    ...
    <view class="set_box" v-if="detail.repairCopyList.length !== 0">
      <view class="set_time">
        <view></view>
      </view>
      <view class="set-1">
          ...
          <view class="right u-fx-ver">
            <view class="u-fx">
              ...
              <view>
                <view
                  class=""
                  v-for="(item, index) in detail.repairCopyList"
                  :key="index"
                >
                  {{ item.copyUserName }}
                </view></view
...
@font-face {
  ...
  /* IE9 */
  src: url("//at.alicdn.com/t/font_1337773_f06f5a7las.eot?t=1565581133395#iefix")
    ...
    /* IE6-IE8 */
      ...
      format("woff2"),
    url("//at.alicdn.com/t/font_1337773_f06f5a7las.woff?t=1565581133395")
      format("woff"),
    url("//at.alicdn.com/t/font_1337773_f06f5a7las.ttf?t=1565581133395")
      format("truetype"),
    /* chrome, firefox, opera, Safari, Android, iOS 4.2+ */
      url("//at.alicdn.com/t/font_1337773_f06f5a7las.svg?t=1565581133395#iconfont")
      format("svg");
  /* iOS 4.1- */
}
