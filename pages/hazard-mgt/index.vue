  ...
  <view>
    <scroll-view scroll-y="true" class="scroll-h" @scrolltolower="loadMore">
      <view class="u-shadow u-fx-ver u-padd-30 u-border-radius tab-box u-fx-f1">
        ...
        <view
          class="card u-type-white-bg u-border-radius u-shadow u-padd-20 u-mar-b20 u-fx"
          @click="
            assignDanger(item.id, item.state, item.leaderCode, item.handlerCode)
          "
        ...
        >
          <view class="img-box">
            <image
              class="u-user-img u-border-radius-all"
              src="https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=1027245443,3552957153&fm=26&gp=0.jpg"
            ></image>
          </view>
          <view class="cont-box u-wh u-mar-l20">
            <view class="cont-title u-font-1 u-mar-b10 u-fx u-bold"
              >{{ item.reportName }}
              <view class="doorkeeper"> (暂无职务) </view>
              <!-- 上报需指派 -->
              <view
                class="red-text"
                v-if="userInfo.userCode == item.leaderCode && item.state == '1'"
              >
                <image
                  class="del-add-img"
                  src="/mobile-img/assigned.png"
                ></image>
              </view>
              <view
                class="red-text"
                v-if="
                  userInfo.userCode == item.handlerCode && item.state == '2'
                "
              >
                <image
                  class="del-add-img"
                  src="/mobile-img/dealwith.png"
                ></image>
              </view>
              <view
                class="red-text"
                v-if="userInfo.userCode == item.leaderCode && item.state == '3'"
              >
                <image
                  class="del-add-img"
                  src="/mobile-img/acceptance.png"
                ></image>
              </view>
            </view>
            ...
            <view class="imgs-box wh u-fx u-mar-t20 u-mar-b20">
              <u-image
                v-for="(url, index) in item.dangerPhotoUrls"
                :key="index"
            ...
            <view class="cont-footer u-fx u-type-primary u-fx-ac u-font-02">
              ...
              <u-icon
                size="20rpx"
                name="http://canpointtest.com/mobile-img/ico_danger.png"
