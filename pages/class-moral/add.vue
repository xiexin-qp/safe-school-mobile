  ...
  import eventBus from '@u/eventBus'
	...
	export default {
		...
		mounted() {
			...
			this.studentInfo.beAssessedName = this.$tools.getQuery().get('name')
			this.studentInfo.beAssessedCode = this.$tools.getQuery().get('code')
			this.studentInfo.classCode = this.$tools.getQuery().get('classCode')
			this.studentInfo.workNo = this.$tools.getQuery().get('workNo')
			this.studentInfo.schoolYearId = this.$tools.getQuery().get('schoolYearId')
			this.recordGet()
    },
    methods: {
			valChange (val, index) {
