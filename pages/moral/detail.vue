  ...
  import eventBus from '@u/eventBus'
    ...
    methods: {
      async rankGet () {
        ...
        const res = await actions.getEduRank(req)
        ...
        this.classOne = res.data.list.length === 0 ? '': res.data.list[0].gradeName + res.data.list[0].beAssessedName
        this.classTwo = res.data.list.length <= 1 ? '': res.data.list[1].gradeName + res.data.list[1].beAssessedName
        this.classThree = res.data.list.length <= 2 ? '': res.data.list[2].gradeName + res.data.list[2].beAssessedName
			},
			async recordGet () {
				const res = await actions.getEduDetail(this.categoryDutyId)
