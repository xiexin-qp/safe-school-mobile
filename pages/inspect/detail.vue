  ...
  <view class="detail u-page">
    ...
    <scroll-view scroll-y="true" class="scroll-h" v-else>
      <view class="detail-top u-fx-ac-jc">
        ...
        <view class="u-font-01 u-type-white">
          检查时间：{{ dataList.checkTime }}
        </view>
      </view>
      <view
        class="detail-content u-type-white-bg u-padd-20 u-mar-b20 u-mar-l20 u-mar-r20"
      >
        <view class="check-name u-type-white"> 检查项目 </view>
        <ul class="detail-list u-fx">
          <li
            class="u-tx-c u-fx-ac-jc"
        ...
        <view class="u-fx">
          <ul class="detail-info info-wth info-bd u-fx-ver">
            <li
              class="u-tx-c u-fx-ac-jc"
              :style="{ flex: list.standardList.length }"
              v-for="(list, index) in dataList.itemList"
              :key="index"
            >
              {{ list.name }}
            </li>
          ...
          <ul class="detail-info u-fx-f1">
            <li
              class="u-tx-c u-fx-ac-jc u-padd-10"
          ...
          <ul class="detail-info info-wth" v-if="state === '4'">
            <li
              ...
              :key="item.id"
            >
              {{ item.inspectionResult === "1" ? "符合" : "不符合" }}
            </li>
          </ul>
        </view>
      </view>
      <view
        class="check-content u-type-white-bg u-mar-t40 u-mar-l20 u-mar-r20 u-padd-t20 u-padd-b20"
      >
