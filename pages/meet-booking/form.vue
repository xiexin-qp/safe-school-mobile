	...
	<view class="u-page u-bg-fff">
		...
		<scroll-view scroll-y="true" class="scroll-h">
			...
			<view class="u-fx-ac u-bd-b item-list">
				...
				<view v-if="type !== '1'" class="rit-icon"></view>
			</view>
			<view class="u-fx-ac u-bd-b item-list">
			...
			<view v-show="formData.room !== '请选择' && type !== '1'" class="u-bd-b item-list">
				<view class="tip mar-b20">会议时间：</view>
				...
				<view class="sign-list u-padd-t u-fx" v-for="(item, index) in signList" :key="index + 'a'">
					...
					<view class="box" v-else>
						<view class="list u-fx-ac-jc"><view class="">无会议记录</view></view>
					</view>
				</view>
			</view>
			<view class="u-fx-ac u-bd-b item-list">
				<view class="tip">参会人员:</view>
...
export default {
	...
	methods: {
		...
		async showData() {
			...
			this.classTitle = `已选择${this.teacherList.length}个教职工`;
		},
		handleShowTree() {
			this.teacherTag = !this.teacherTag;
		},
		close() {
			this.teacherTag = false;
		},
		teacherSelcet(teacherInfo) {
