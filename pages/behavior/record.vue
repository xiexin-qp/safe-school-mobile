<template>
  <view class="leave u-page">
    ...
    <view class="search-list u-fx">
      <u-search placeholder="学号/学生姓名" v-model="keyword" bg-color="#fff" shape="square" :show-action="false" height="75"></u-search> 
    <view class="search-icon">
     <u-button size="mini" :custom-style="customStyle" @click="teacherLeaveGet">筛选</u-button>
    </view>
    </view>
        ...
        <view class="record-box">
          <view class="leave-box u-fx-ac" v-for="(item,index) in leaveList" :key="index" @click="detail(item.id)">
            ...
            <view class="leave-info u-fx-f1"> 
              ...
              <view class="u-type-info-dark u-font-01 u-mar-t10">{{ item.studentName }} {{ item.studentNo }} {{ item.gradeName }} {{ item.className }} </view>
