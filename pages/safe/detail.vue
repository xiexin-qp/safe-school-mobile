<template>
  <view>
      ...
      <view v-if="detailInfo.taskType === '2'">
        <view class="content-title u-padd-l20 u-padd-r20 u-fx-jsb">
          <view class="u-font-1"> 检查设备 </view>
          <view v-if="detailInfo.state === '1'"> 异常/正常 </view>
        </view>
        <view class="collapse-box" v-for="list in detailInfo.checkList" :key="list.id">
          <u-collapse :item-style="itemStyle" v-if="list.children && list.children.length > 0">
            <u-collapse-item :title="list.name">
              <view class="add-item u-padd-20 u-fx-jsb u-bd-b" v-for="item in list.children" :key="item.id">
                <view>{{item.name}}</view>
                <u-switch v-model="item.checked" v-if="detailInfo.state === '1'" disabled :size="30"></u-switch>
              </view>
            </u-collapse-item>
          </u-collapse>
      ...
      <view v-if="detailInfo.taskType === '3'">
        <view class="content-title u-padd-l20 u-padd-r20 u-fx-jsb">
        ...
        <view class="add-content u-fx-ver u-bg-fff">
          ...
          <view class="u-bd-b u-padd-20">
            <view>护导报告：{{detailInfo.remark}}</view>
          </view>
          <view class="u-bd-b u-padd-20">
            <view>照片：</view>
